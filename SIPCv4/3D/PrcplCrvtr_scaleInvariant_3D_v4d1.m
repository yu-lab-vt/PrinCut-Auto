function curvature_merged=PrcplCrvtr_scaleInvariant_3D_v4d1(dat,smFactorLst,zRatio)
...
for smCnt=1:N_smNum
    ...
    curvature_temp=getCurvature_3D_v4d1(dat,smFactor);
    curvature_temp=curvature_temp*(smFactor(1)^(3/2));
