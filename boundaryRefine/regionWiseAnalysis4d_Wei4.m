function [newIdMap_refined,newIdMap_refined2,newIdMap,sigmaLst,sigmaLst2,FGLst,BGLst,zLst] = regionWiseAnalysis4d_Wei4(idMap, ...
    eigMap, vid,varFit)
...
parfor i=1:N
    disp(i);
    [replaceLst(i),zLst(i),sigmaLst(i),FGLst{i},BGLst{i}]=...
        removeFalsePositiveCell3(i,idMapCropLst{i},vidCropLst{i});
end

newIdMap_refined=newIdMap;
for i=1:N
    if replaceLst(i)==0
        replaceLst(replaceLst==i)=0;
    end
end
for i=1:N
...
parfor i=1:N
    disp(i);
    [replaceLst(i),~,sigmaLst2(i),~,~]=...
        removeFalsePositiveCell4(i,idMapCropLst{i},vidCropLst{i},varFit);
end

newIdMap_refined2=newIdMap;
for i=1:N
    if replaceLst(i)==0
        replaceLst(replaceLst==i)=0;
    end
...
for i=1:N
    newIdMap_refined2(regionIdxLst{i})=replaceLst(i);
end
newIdMap_refined2 = region_sanity_check(newIdMap_refined2, 1);
