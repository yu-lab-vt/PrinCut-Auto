function newIdMap_refined = regionWiseAnalysis4d_Wei7(idMap,eig3d, vid)
...
% for i=1:N
% %     disp(i);
%     replaceLst(i)=removeFalsePositiveCell6(i,idMapCropLst{i},vidCropLst{i});
% end
% 
...
newIdMap_refined = region_sanity_check(newIdMap, 1);
