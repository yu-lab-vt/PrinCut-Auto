function [newIdMap_refined,newIdMap_refined2,newIdMap,sigmaLst,sigmaLst2,FGLst,BGLst,zLst] = regionWiseAnalysis4d_Wei3(idMap, ...
    eigMap, vid,varFit)
...
parfor i=1:N
    ...
    [replaceLst(i),zLst(i),sigmaLst(i),FGLst{i},BGLst{i}]=...
        removeFalsePositiveCell5(i,idMapCropLst{i},vidCropLst{i});
end
