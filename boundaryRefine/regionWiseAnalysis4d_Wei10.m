function [newIdMap_refined,thresholdMap] = regionWiseAnalysis4d_Wei10(seedMap,eig3d, vid)
...
[newIdMap_refined,thresholdMap]=boundaryRefineModule(idMap_current,eig3d, vid);
end